...
const initialState: AppState = { user: {oid: '0',study_code: '', sponsor_code:'', demo:initialDemo, forms:[],exlusion_code: -1, assessments:[], results:[], message: ''}, admin:{"_id":"0","username":"","password":"","sponsor_code":"","message":""}};
